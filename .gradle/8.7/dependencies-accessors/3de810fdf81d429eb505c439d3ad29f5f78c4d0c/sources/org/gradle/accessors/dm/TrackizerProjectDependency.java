...
@NonNullApi
public class TrackizerProjectDependency extends DelegatingProjectDependency {

    @Inject
    public TrackizerProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
